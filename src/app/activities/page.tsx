...
import { afternoonClubs, type Activity } from '@/lib/site-content';
...
export const metadata: Metadata = {
  title: 'Activities',
  description:
    'Surfing, football, dance, scouting, and adventure camps at Selong Bay School: open to the whole community, not just enrolled students. Book a slot online.',
  openGraph: {
    title: 'Activities - Selong Bay School',
