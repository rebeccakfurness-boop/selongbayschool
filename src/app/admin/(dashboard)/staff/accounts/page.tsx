  ...
  return (
    <section>
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="font-display text-2xl font-semibold text-ink">Staff Accounts &amp; Access</h1>
          <p className="mt-1 max-w-2xl text-[15px] text-ink-soft">
            Create admin/teacher logins and assign teachers to the classes they should see on the Family Board,
            Calendar, and Teaching pages.
          </p>
        </div>
        <StaffTabs active="accounts" />
      </div>
      <div className="mt-6">
