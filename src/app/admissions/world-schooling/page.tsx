...
export const metadata: Metadata = {
  ...
  description:
    'World schooling at Selong Bay School: join afternoon activities, full or half days, for a single day or several weeks, and continue online while you travel.',
    ...
    <div className="flex flex-col gap-14 pb-20 md:gap-20">
      ...
      <Reveal>
        <div className="mx-auto max-w-4xl px-6 md:px-8">
          ...
          <h2 className="mt-1 font-display text-3xl font-semibold text-ink md:text-4xl">What is World Schooling?</h2>
          <div className="mt-5 space-y-4 text-[17px] leading-relaxed text-ink-soft">
            <p>
              World schooling is an approach to education where learning happens through travel, real-world experiences, and
              immersion in different cultures and environments, rather than being confined to a traditional classroom.
              Families who world school often travel for extended periods, using the places they visit as living
              classrooms: learning geography by exploring a coastline, biology through jungle treks, marine science through
              surfing and snorkelling, and social studies through meeting local communities.
            </p>
            <p>
              Many world schooling families combine this approach with homeschooling curricula, unschooling philosophies, or
              online schools, dropping into local communities and programmes along the way for structure, socialisation, and
              hands-on activities. Selong Bay School is proud to be one of those stops for families travelling through
              Lombok.
            </p>
          </div>
        </div>
      ...
      <Reveal>
        <div className="mx-auto max-w-4xl px-6 md:px-8">
          ...
          <h2 className="mt-1 font-display text-3xl font-semibold text-ink md:text-4xl">How World Schooling Works at Selong Bay School</h2>
          ...
          <h3 className="mt-8 font-display text-xl font-semibold text-ink">Community at the centre:</h3>
          <p className="mt-3 text-[17px] leading-relaxed text-ink-soft">
            World schooling is as much about connection as it is about curriculum, so we build in regular opportunities for
            families to meet, share, and explore together:
          </p>
          <ul className="mt-4 flex flex-col gap-3">
            <Bullet>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <PlaceholderImage label="Photo needed: Surfing at Selong Belanak (Wednesday community get-togethers)" className="aspect-video w-full" />
          ...
          <p className="mt-3 text-[17px] leading-relaxed text-ink-soft">
            Part of the world schooling experience is discovering the island itself, and we&apos;re happy to help arrange it:
          </p>
          <ul className="mt-4 flex flex-col gap-3">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <PlaceholderImage label="Photo needed: Camp out / adventure week" className="aspect-square w-full" />
          </div>
        </div>
      </Reveal>
      ...
      <Reveal>
        <div className="mx-auto max-w-4xl px-6 md:px-8">
          ...
          <h2 className="mt-1 font-display text-3xl font-semibold text-ink md:text-4xl">Continuing the Programme While You Travel</h2>
          <p className="mt-5 text-[17px] leading-relaxed text-ink-soft">
          ...
          <div className="mt-6 max-w-lg">
            <PlaceholderImage label="Photo needed: Family / online-learning style image" className="aspect-video w-full" />
          </div>
          ...
          <h3 className="mt-8 font-display text-xl font-semibold text-ink">Regular online teaching sessions:</h3>
          <ul className="mt-4 flex flex-col gap-3">
            <Bullet>
              <strong className="font-semibold text-ink">Primary:</strong> one online home room session per week with a home
              room teacher
            </Bullet>
            <Bullet>
      ...
      <Reveal>
        <div className="mx-auto max-w-4xl px-6 md:px-8">
          ...
          <h2 className="mt-1 font-display text-3xl font-semibold text-ink md:text-4xl">Planning Your World Schooling Stay at Selong Bay</h2>
          <p className="mt-5 text-[17px] leading-relaxed text-ink-soft">
          ...
          <div className="mt-8 flex flex-col gap-8">
            <div>
              ...
              <p className="mt-2 text-[17px] leading-relaxed text-ink-soft">
                Reach out to us and we&apos;ll arrange a short online call (video or voice) to introduce our programme, hear
                about your child&apos;s age, interests, and learning background, and answer any questions you have.
              </p>
            </div>

            <div>
              <h3 className="font-display text-xl font-semibold text-ink">Step 2: Confirm Your Dates</h3>
              <p className="mt-2 text-[17px] leading-relaxed text-ink-soft">
            ...
            <div>
              <h3 className="font-display text-xl font-semibold text-ink">Step 3: Confirm Full Days or Half Days</h3>
              <p className="mt-2 text-[17px] leading-relaxed text-ink-soft">
            ...
            <div>
              <h3 className="font-display text-xl font-semibold text-ink">Step 4: Confirm Any Additional Requirements</h3>
              <p className="mt-2 text-[17px] leading-relaxed text-ink-soft">A few things to sort out before arrival:</p>
              <ul className="mt-4 flex flex-col gap-3">
                <Bullet>
                  <strong className="font-semibold text-ink">School reports:</strong> Let us know whether your child needs a
                  school report or record of learning at the end of their stay (some world schooling and homeschooling
                  families need this for their home curriculum, visa, or portfolio requirements). We&apos;re happy to provide
                  one on request.
                </Bullet>
                <Bullet>
                ...
                <Bullet>
                  <strong className="font-semibold text-ink">Health, dietary, or swimming ability notes:</strong> Given our
                  beach and surf-based activities, please let us know of any allergies, medical considerations, or swimming
                  ability in advance.
                </Bullet>
              </ul>
            </div>
            ...
            <div>
              <h3 className="font-display text-xl font-semibold text-ink">Step 5: Arrive and Settle In</h3>
              <p className="mt-2 text-[17px] leading-relaxed text-ink-soft">
                On arrival, we&apos;ll do a short orientation, introduce your child to their group, and get them settled into
                the rhythm of the school and the wider world schooling community.
              </p>
            </div>
          </div>
        </div>
