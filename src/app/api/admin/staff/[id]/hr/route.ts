  ...
  try {
    ...
    const rows = await sql`
      UPDATE admin_users SET
        ...
        postal_address = COALESCE(${d.postalAddress ?? null}, postal_address),
        ...
        npwp_number = COALESCE(${d.npwpNumber ?? null}, npwp_number),
        tax_status = COALESCE(${d.taxStatus ?? null}, tax_status),
        npwp_url = COALESCE(${d.npwpUrl ?? null}, npwp_url),
        national_id_url = COALESCE(${d.nationalIdUrl ?? null}, national_id_url),
