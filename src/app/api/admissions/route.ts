...
import { admissionsSchema } from '@/lib/validation';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error('[api/admissions] failed to submit enquiry', err);
