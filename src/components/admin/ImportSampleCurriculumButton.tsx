 ...
 * Mathematics, English and Science (33 programmes total), explicitly labelled "(draft)" throughout
 * so nobody mistakes them for the school's actual confirmed term plans. Safe to click more than
 * once: the import route checks first and skips any programme that already exists rather than
 * duplicating. */
  ...
  return (
    <div className="rounded-md border border-dashed border-teal/40 bg-teal/5 p-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-sm font-semibold text-ink">Import draft sample terms (Primary 1–6, Secondary 6–10 · Maths, English, Science)</p>
          <p className="text-xs text-ink-soft">
            Worked examples across eleven grades and three subjects — 33 programmes, each drafted around the
            Cambridge Primary, Lower Secondary, and IGCSE frameworks&apos; stage-by-stage strands. Explicitly a
            draft: review every objective before teaching from it, and each lesson still needs its own
            worksheet attached.
          </p>
        </div>
        <button
