  ...
  async function run() {
    if (
      !confirm(
        ...
        '(Football on Mondays from 3 August), and School Tour at midday Mon-Fri (capacity 8). Gymnastics for Kids ' +
        '& Free Swim switches to "Coming in September" with no bookable sessions for now. Hip Hop Dance and Ninja ' +
        'Warrior stays retired. Any old slot that’s not part of the new schedule will be removed — sessions with ' +
        'real bookings will be cancelled and those families will be emailed. This cannot be undone. Continue?'
      )
    ) {
      return;
    }
  ...
  return (
    <div className="rounded-md border border-orange/30 bg-orange/5 p-5">
      ...
      <p className="mt-1 text-sm text-ink-soft">
        ...
        &amp; Free Swim set to &quot;Coming in September&quot; with no bookable sessions yet, Hip Hop Dance &amp; Ninja
        Warrior still retired) and removes every slot that no longer belongs.
      </p>
      <div className="mt-3">
