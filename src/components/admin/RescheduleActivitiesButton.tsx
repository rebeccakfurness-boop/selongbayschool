  ...
  async function run() {
    if (
      !confirm(
        ...
        'midday Mon-Fri (capacity 8). Hip Hop Dance and Ninja Warrior stays retired. Any old slot that’s not part ' +
        'of the new schedule will be removed — sessions with real bookings will be cancelled and those families ' +
  ...
  return (
    <div className="rounded-md border border-orange/30 bg-orange/5 p-5">
      ...
      <p className="mt-1 text-sm text-ink-soft">
        ...
        &amp; Free Swim back on Tuesdays, Hip Hop Dance &amp; Ninja Warrior still retired) and removes every slot that
        no longer belongs.
      </p>
      <div className="mt-3">
